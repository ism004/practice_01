...
class Program
{
    static void Main(string[] args)
    {
        ...
        // Извлекаем символы, представляющие номер строки и номер столбца для первого поля
        char field1Row = field1Coordinates[1];
        char field1Column = field1Coordinates[0];
        // Извлекаем символы, представляющие номер строки и номер столбца для второго поля
        ...
        {
            // Если номер строки для обоих полей чётный или нечётный - поля одного цвета
