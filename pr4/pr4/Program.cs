...
class Program
{
    static void Main(string[] args)
    {
        ...
        // Извлекаем символы, представляющие номер строки и номер столбца для короля
        ...
        {
            // Если номер строки или столбца короля совпадает с номером строки или столбца фигуры,
            // или есть разница между номерами строк и столбцов, которая равна 1, король может побить фигуру
