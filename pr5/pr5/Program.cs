...
class Program
{
    static void Main(string[] args)
    {
        ...
        // Извлекаем символы, представляющие номер строки и номер столбца для коня
        ...
        {
            // Если есть разница между номерами строк и столбцов, которая равна 2, конь может побить фигуру
